    ...
    return(
        <Popover className="relative">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden">
                ...
                <button className="px-4 h-14 w-full inline-flex items-center gap-5 hover:bg-[#eff3f41a] transition-colors">
                    <div className="w-[24px] h-[24px] relative">
                        <svg viewBox="0 0 24 24"  width={26.25} height={26.25} fill="#e7e9ea"><path d="M8 18V6H4.5c-.28 0-.5.22-.5.5v11c0 .28.22.5.5.5H8zm11.5 0c.28 0 .5-.22.5-.5v-11c0-.28-.22-.5-.5-.5H16v12h3.5zM10 6v12h4V6h-4zM4.5 20C3.12 20 2 18.88 2 17.5v-11C2 5.12 3.12 4 4.5 4h15C20.88 4 22 5.12 22 6.5v11c0 1.38-1.12 2.5-2.5 2.5h-15z"/></svg>
                    </div>
                    <div className="pr-4 text-xl font-bold">
                        Pro
                    </div>
                ...
                <button className="px-4 h-14 w-full inline-flex items-center gap-5 hover:bg-[#eff3f41a] transition-colors">
                    <div className="w-[24px] h-[24px] relative">
                        <svg viewBox="0 0 24 24"  width={26.25} height={26.25} fill="#e7e9ea"><path d="M1.996 5.5c0-1.38 1.119-2.5 2.5-2.5h15c1.38 0 2.5 1.12 2.5 2.5v13c0 1.38-1.12 2.5-2.5 2.5h-15c-1.381 0-2.5-1.12-2.5-2.5v-13zm2.5-.5c-.277 0-.5.22-.5.5v13c0 .28.223.5.5.5h15c.276 0 .5-.22.5-.5v-13c0-.28-.224-.5-.5-.5h-15zm8.085 5H8.996V8h7v7h-2v-3.59l-5.293 5.3-1.415-1.42L12.581 10z"/></svg>
                    </div>
                    <div className="pr-4 text-xl font-bold">
                    Reklamlar
                    </div>
