...
export default function Search(){
    ...
    return(
        ...
        ref={ref}
            ...
            <label className="h-[43px] rounded-full bg-[color:var(--background-third)] w-full group relative border border-transparent focus-within:bg-[color:var(--background-primary)] focus-within:border-[#1d9bf0]">
