...
export default function Search(){
    ...
    return(
        ...
        ref={ref}
            ...
            <label className="h-[2.688rem] rounded-full bg-[color:var(--background-third)] w-full group relative border border-transparent focus-within:bg-[color:var(--background-primary)] focus-within:border-[color:var(--color-primary)]">
                <div className="w-[3.5rem] h-full flex items-center justify-center absolute top-0 left-0 pointer-events-none">
                    <svg viewBox="0 0 24 24" className="h-[1.172rem] min-w-[2rem] text-[color:var(--color-base-secondary)] group-focus-within:text-[color:var(--color-primary)]"><path fill="currentColor" d="M10.25 3.75c-3.59 0-6.5 2.91-6.5 6.5s2.91 6.5 6.5 6.5c1.795 0 3.419-.726 4.596-1.904 1.178-1.177 1.904-2.801 1.904-4.596 0-3.59-2.91-6.5-6.5-6.5zm-8.5 6.5c0-4.694 3.806-8.5 8.5-8.5s8.5 3.806 8.5 8.5c0 1.986-.682 3.815-1.824 5.262l4.781 4.781-1.414 1.414-4.781-4.781c-1.447 1.142-3.276 1.824-5.262 1.824-4.694 0-8.5-3.806-8.5-8.5z"></path></svg>
                </div>
                <input 
                    type="text"
                    placeholder="Ara"
                    className="placeholder-[#71767b] w-full h-full bg-transparent rounded-full outline-none pl-[3.5rem]"
                    value={query}
            ...
            {focus && (
                <div className="absolute top-full w-full bg-[color:var(--background-primary)] shadow-box max-h-[calc(80vh-53px)] pt-5 p-3 text-[color:var(--color-base-secondary)] text-center leading-5 min-h-[100px]">
